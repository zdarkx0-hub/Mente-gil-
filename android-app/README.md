...
A partir da 1.2.0, o site usa cache de aplicação e armazenamento privado criptografado
para permitir estudo offline depois da primeira abertura online. O ranking permanece
dependente de internet para validação antifraude.
